 ...
 * @LastEditTime: 2026-02-25 18:25:13
...
<script setup lang="ts">
  ...
  const basicItems: CollapsePanelItem[] = [
  ...
  const faqItems: CollapsePanelItem[] = [
    {
      key: 'q1',
  ...
  const cardItems: CollapsePanelItem[] = [
  ...
  const ghostItems: CollapsePanelItem[] = [
  ...
  const lazyItems: CollapsePanelItem[] = [
    {
      key: 'lazy-normal',
      title: '默认渲染',
  ...
  const disabledItems: CollapsePanelItem[] = [
